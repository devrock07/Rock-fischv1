...
Gui, Color, 0x121212, 0x1E1E1E  ; Darker theme colors
Gui, Font, s10, Segoe UI  ; Modern font

; Header Section
Gui, Add, Text, x10 y10 w270 h30 cWhite Center,  Bot Settings
Gui, Add, Text, x10 y40 w270 h20 c0xFF7F00 Center, Made by Devrock  ; Static orange color

; Settings Section
Gui, Add, GroupBox, x10 y70 w270 h140 cWhite, Settings
Gui, Add, CheckBox, x20 y90 vAutoLowerGraphicsChecked Checked%AutoLowerGraphics% cWhite, Auto Lower Graphics
Gui, Add, CheckBox, x20 y110 vAutoZoomInCameraChecked Checked%AutoZoomInCamera% cWhite, Auto Zoom In Camera
Gui, Add, CheckBox, x20 y130 vAutoEnableCameraModeChecked Checked%AutoEnableCameraMode% cWhite, Auto Enable Camera Mode
Gui, Add, CheckBox, x20 y150 vAutoLookDownCameraChecked Checked%AutoLookDownCamera% cWhite, Auto Look Down Camera
Gui, Add, CheckBox, x20 y170 vAutoBlurCameraChecked Checked%AutoBlurCamera% cWhite, Auto Blur Camera

; Buttons Section
Gui, Add, Button, x20 y220 w120 h30 gSaveSettings cWhite Background0x2D2D2D, 💾 Save Settings
Gui, Add, Button, x150 y220 w120 h30 gStartBot cWhite Background0x2D2D2D, 🚀 Start Bot

Gui, Show, w290 h260, Menu
return
